...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::github_environments::get_github_environments,
            commands::github_environments::get_github_environment_configuration,
            commands::github_environments::save_github_environment,
            commands::github_environments::delete_github_environment,
            commands::github_environments::set_github_environment_variable,
            commands::github_environments::delete_github_environment_variable,
            commands::github_environments::set_github_environment_secret,
            commands::github_environments::delete_github_environment_secret,
            ...
            commands::github_releases::create_github_release,
            commands::github_releases::edit_github_release,
            commands::github_releases::upload_github_release_assets,
            commands::github_releases::download_github_release,
            commands::github_resources::get_github_projects,
            commands::github_resources::get_github_project_items,
            commands::github_resources::get_github_discussions,
            commands::github_resources::get_github_codespaces,
